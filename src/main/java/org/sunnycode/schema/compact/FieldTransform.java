...
import org.sunnycode.schema.Attribute;
...
import org.sunnycode.schema.types.TypeTransforms;

/**
 * Type-based compaction for object instances. For example, boolean compacts to
 * char, datetime compacts to long, enum compacts to int. This results in more
 * marshalling more compact values.
 */
public class FieldTransform implements
        Transform<Map<String, Object>, Map<String, Object>> {
    ...
    public FieldTransform(Schema schema) {
        ...
        for (Attribute attribute : schema.getAttributes()) {
            newFieldCompactions.put(attribute.getName(),
                    TypeTransforms.validatorFor(attribute));
        }

        this.fieldCompactions = Collections
                .unmodifiableMap(newFieldCompactions);
    }

    @Override
    public Map<String, Object> pack(Map<String, Object> instance)
        ...
        for (Map.Entry<String, Transform> e : fieldCompactions.entrySet()) {
            ...
            if (inbound == null) {
                ...
                throw new TransformException("attribute must not be null: "
                        + attrName);
            }
            ...
            try {
                ...
                throw new TransformException("invalid attribute value for '"
                        + attrName + "'");
            }
        }
    ...
    @Override
    public Map<String, Object> unpack(Map<String, Object> instance)
            throws TransformException {
        if (instance == null) {
            throw new TransformException("instance must not be null");
        }
