...
import org.sunnycode.schema.compact.FieldTransform;
...
public class FieldTransformTest {
    ...
    public void testTransforms() {
        ...
        Assert.assertEquals(bools.pack(something), ImmutableMap
                .<String, Object> of("foo", "ONE", "bar", 1L, "baz", true,
                        "quux", now));
        Assert.assertEquals(bools.pack(somethingElse), ImmutableMap
                .<String, Object> of("foo", "THREE", "bar", -1L, "baz", false,
                        "quux", then));
        ...
        Assert.assertEquals(dates.pack(something), ImmutableMap
                .<String, Object> of("foo", "ONE", "bar", 1L, "baz", "true",
                        "quux", now.getMillis() / 1000L));
        Assert.assertEquals(dates.pack(somethingElse), ImmutableMap
                .<String, Object> of("foo", "THREE", "bar", -1L, "baz",
                        "false", "quux", then.getMillis() / 1000L));
        ...
        Assert.assertEquals(enums.pack(something), ImmutableMap
                .<String, Object> of("foo", 0, "bar", 1L, "baz", "true",
                        "quux", now));
        Assert.assertEquals(enums.pack(somethingElse), ImmutableMap
                .<String, Object> of("foo", 2, "bar", -1L, "baz", "false",
                        "quux", then));
    }

    private void assertRoundTrip(Transform transform, Object... objects) {
