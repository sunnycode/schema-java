...
import org.sunnycode.schema.SchemaValidator;
...
public class SchemaValidatorTest {
    public void testAttributeUpgrades() {
        ...
        for (Type type : new Type[] { Type.ANY, Type.ARRAY, Type.BOOLEAN,
                Type.CHAR_ONE, Type.MAP }) {
            SchemaValidator.validateAttributeUpgrade(a("foo", type),
                    a("foo", type));
        ...
        SchemaValidator.validateAttributeUpgrade(
                a("foo", Type.UTF8_SMALLSTRING),
                a("foo", Type.UTF8_SMALLSTRING));
        SchemaValidator.validateAttributeUpgrade(
                a("foo", Type.UTF8_SMALLSTRING), a("foo", Type.UTF8_TEXT));
        SchemaValidator.validateAttributeUpgrade(
                a("foo", Type.UTF8_SMALLSTRING), null);

        SchemaValidator.validateAttributeUpgrade(a("foo", Type.UTF8_TEXT),
    ...
    public void testEnumUpgrades() {
        SchemaValidator.assertEnumAttributeCompatible(
                a("foo", Type.ENUM, "dude"), a("foo", Type.ENUM, "dude"));
        SchemaValidator.assertEnumAttributeCompatible(
                a("foo", Type.ENUM, "dude"),
    ...
    public void testIllegalEnumUpgradeFewer() {
        SchemaValidator.assertEnumAttributeCompatible(
                a("foo", Type.ENUM, "dude"), a("foo", Type.ENUM));
    }
    ...
    public void testIllegalEnumUpgradeInsertInMiddle() {
        SchemaValidator.assertEnumAttributeCompatible(
                a("foo", Type.ENUM, "dude", "dude2", "dude3"),
    ...
    private void validateNumericType(Type[] possibleTypes) {
        ...
        for (Type type : possibleTypes) {
            SchemaValidator.validateAttributeUpgrade(a("foo", baseType),
                    a("foo", type));
        }
